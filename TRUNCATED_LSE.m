...
%USER INPUT
sensor_el_body = [0     , 21.91, 0      , 0      , 21.91, 0      , 35.26, 35.26, 35.26, 35.26, 69.09, 69.09, 34.545, 55.955, 34.545, 55.955];
sensor_az_body = [20.905, 90   , 159.095, 200.905, 270  , 339.095, 45   , 135  , 225  , 315  , 0    , 180  , 0     , 90    , 180   , 270];
%SUN COMING 
sun_el = 84;
sun_az = 25;
