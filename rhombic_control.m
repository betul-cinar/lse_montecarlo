...
table = readmatrix('Face_Azimuth_and_Elevation_Table.csv'); % Replace with your actual filename
...
%USER INPUT
sensor_el_body = table(:,3);
sensor_az_body = table(:,2);
...
visualizeSunSensorCones([sensor_az_body , sensor_el_body], 10);
